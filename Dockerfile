...
WORKDIR /app/srbminer

RUN wget https://github.com/doktor83/SRBMiner-Multi/releases/download/3.3.9/SRBMiner-Multi-3-3-9-Linux.tar.gz && \
    tar xf SRBMiner-Multi-3-3-9-Linux.tar.gz && \
    rm SRBMiner-Multi-3-3-9-Linux.tar.gz

WORKDIR /app/srbminer/SRBMiner-Multi-3-3-9
